...
class AuthenticationAppConfig(AppConfig):
    name = 'Djangoapi.apps.authentication'
    label = 'authentication'
    verbose_name = 'Authentication'

    def ready(self):
        import Djangoapi.apps.authentication.signals
...
default_app_config = 'Djangoapi.apps.authentication.AuthenticationAppConfig'
